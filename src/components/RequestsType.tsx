...
const RequestsType = () => {
  ...
  const getErrorMessage = (error: unknown) => {
    ...
    if (Array.isArray(err.response?.data?.details) && err.response?.data?.details[0]) {
  ...
  const validationSchema = Yup.object({
    ...
    skills: type === "volunteer" ? Yup.string().required("Required") : Yup.string(),
    reason: type === "volunteer" ? Yup.string().required("Required") : Yup.string(),
  });
                ...
                <>
                  ...
                  <div className="w-full">
                    ...
                    <div className="relative">
                      ...
                      {touched.orphanHelpType && errors.orphanHelpType && (
                        <p className="text-red-500 text-sm mt-1">{errors.orphanHelpType}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="w-full">
                    ...
                    {touched.orphanNotes && errors.orphanNotes && (
                      <p className="text-red-500 text-sm mt-1">{errors.orphanNotes}</p>
                    )}
                  </div>
                </>
              )}
                ...
                <>
                  ...
                  <div className="w-full">
                    ...
                    {touched.familyAddress && errors.familyAddress && (
                      <p className="text-red-500 text-sm mt-1">{errors.familyAddress}</p>
                    )}
                  </div>
                  ...
                  <div className="w-full">
                    ...
                    <div className="relative">
                      ...
                      {touched.familyHelpType && errors.familyHelpType && (
                        <p className="text-red-500 text-sm mt-1">{errors.familyHelpType}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="w-full">
                    ...
                    {touched.familyNotes && errors.familyNotes && (
                      <p className="text-red-500 text-sm mt-1">{errors.familyNotes}</p>
                    )}
                  </div>
                </>
              )}
